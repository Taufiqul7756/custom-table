            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  rows={14}
                  className={`w-full font-mono text-xs border rounded-lg p-3 resize-none focus:outline-none focus:ring-2 transition-colors ${
                    error
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative flex-1">
                  <pre className="font-mono text-xs bg-gray-50 border border-gray-200 rounded-lg p-3 h-full overflow-auto text-gray-600 leading-relaxed">
                    {FORMAT_EXAMPLE}
                  </pre>
                  <button
                    onClick={() => {
